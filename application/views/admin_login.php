			...
			<div class="login-fields">
			    ...
			    <form action="" method="post">
					...
					<div class="field">
						...
						<input type="email" name="email" placeholder="Email" required="" value="" class="login username-field">
						<?php echo form_error('email','<span class="help-block">','</span>'); ?>
					</div> <!-- /field -->
					
					<div class="field">
						<label for="password">Password:</label>			          
						<input type="password" class="login password-field" name="password" placeholder="Password" required="">
